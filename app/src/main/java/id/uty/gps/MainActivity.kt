...
import com.google.android.gms.location.LocationServices as LocationServices1
            ...
            REQUEST_CODE -> {
                if (grantResults.size > 0) {
                    if (grantResults[0] == PackageManager.PERMISSION_GRANTED)
                        Toast.makeText(
                            this@MainActivity, "Permition granted",
                            Toast.LENGTH_SHORT
                        )
                            .show()
                    else
                        Toast.makeText(
                            this@MainActivity, "Permition denied",
                            Toast.LENGTH_SHORT
                        )
                            .show()
                }
                ...
                else
                {
                    ...
                    fusedLocationProviderClient = LocationServices1.getFusedLocationProviderClient(this)
